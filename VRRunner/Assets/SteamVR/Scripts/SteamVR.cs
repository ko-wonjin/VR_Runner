...
namespace Valve.VR
{
    public class SteamVR : System.IDisposable
    {
        ...
        public static TrackedDevicePose_t[] _poses;
        ...
        private void OnNewPoses(TrackedDevicePose_t[] poses)
        {
            ...
            //Debug.Log(CVRSystem.GetDeviceToAbsoluteTrackingPose(ETrackingUniverseOrigin.TrackingUniverseStanding, 0.0f, _poses));
            _poses = new TrackedDevicePose_t[OpenVR.k_unMaxTrackedDeviceCount];
            hmd.GetDeviceToAbsoluteTrackingPose(ETrackingUniverseOrigin.TrackingUniverseStanding, 0.0f, _poses);
